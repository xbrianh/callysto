...
def get_version():
    filepath = os.path.join(os.path.dirname(__file__), "callysto", "version.py")
    if os.path.isfile(filepath):
        # In source distributions or builds, version is available in the generated callysto/version.py file
...
setup(
    ...
    url="https://github.com/xbrianh/callysto.git",
